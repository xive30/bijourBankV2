// <block:setup:1>
const datapoints = soldes; //solde apres chaque opérations
let DATA_COUNT = datapoints.length +2; //nombres d'operations dans le graphique
...
const config = {
  ...
  options: {
    ...
    scales: {
      // fait apparaitre une grille dans le graphique
      x: {
        display: false,
        //min: 1,
